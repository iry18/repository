...
public class DettaglioOrdineServlet extends HttpServlet {
    ...
    private static final Logger LOGGER = Logger.getLogger(DettaglioOrdineServlet.class.getName());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            request.getRequestDispatcher("/WEB-INF/jsp/dettaglioOrdine.jsp").forward(request, response);
        } catch (SQLException e) {
