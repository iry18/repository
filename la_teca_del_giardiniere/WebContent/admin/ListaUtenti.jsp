...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/ListaUtenti.css"> <%-- You might need to create this CSS file --%>
...
<body>
    <div class="container">
        ...
        <div class="add-button-container">
            <a href="${pageContext.request.contextPath}/admin/AggiungiUtenteServlet" class="button add-button">Aggiungi Nuovo Utente</a>
        </div>
