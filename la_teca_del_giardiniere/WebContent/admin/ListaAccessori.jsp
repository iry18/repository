...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/homepage.css"> <%-- Assicurati che il percorso sia corretto --%>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;700&display=swap" rel="stylesheet">

    <style>
        /* Stili ripresi o adattati dal tuo CSS per le piante */
        body {
        ...
        @media (max-width: 768px) {
            ...
            .accessories-table td:nth-of-type(2):before { content: "Immagine:"; }
            .accessories-table td:nth-of-type(3):before { content: "Nome:"; }
            .accessories-table td:nth-of-type(4):before { content: "Prezzo:"; }
            .accessories-table td:nth-of-type(5):before { content: "Disponibilità:"; }
            .accessories-table td:nth-of-type(6):before { content: "Descrizione:"; }
            .accessories-table td:nth-of-type(7):before { content: "Dimensioni:"; }
            .accessories-table td:nth-of-type(8):before { content: "Data Inserimento:"; }
            .accessories-table td:nth-of-type(9):before { content: "Azioni:"; }
        }
    </style>
</head>
<body>
    <header>
        <nav>
            <ul>
                <li><a href="${pageContext.request.contextPath}/admin/adminHome.jsp">HOME ADMIN</a></li>
    ...
    <section class="admin-section">
        ...
        <div class="add-accessory-button-container">
            <a href="${pageContext.request.contextPath}/admin/AccessoriServlet?action=new">Aggiungi Nuovo Accessorio</a>
        </div>
                    ...
                    <tbody>
                        <c:forEach var="acc" items="${listaAccessori}">
                            <tr>
                                <td>${acc.id}</td>
                                <td>
                                    <c:if test="${not empty acc.urlImmagine}">
                                        <img src="${pageContext.request.contextPath}/images/${acc.urlImmagine}" alt="${acc.nome}">
                                    </c:if>
                                    <c:if test="${empty acc.urlImmagine}">
                                        N/D
                                    </c:if>
                                </td>
                                <td>${acc.nome}</td>
                                ...
                                <td>${acc.descrizione}</td>
                                <td>${acc.dimensioni}</td>
                                <td><fmt:formatDate value="${acc.dataInserimento}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                <td class="actions">
                                    <a href="${pageContext.request.contextPath}/admin/AccessoriServlet?action=edit&id=${acc.id}" class="edit-btn">Modifica</a>
                                    <a href="${pageContext.request.contextPath}/admin/AccessoriServlet?action=delete&id=${acc.id}" class="delete-btn" onclick="return confirm('Sei sicuro di voler eliminare questo accessorio?');">Elimina</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
