    ...
    <section class="admin-dashboard">
        ...
        <div class="admin-menu-grid">
            ...
            <div class="admin-menu-item">
                ...
                <a href="gestione-accessori.jsp"> Gestione Accessori</a>
                <a href="FormInserimentoAccessori.jsp">Form Inserimento</a>
                <a href="${pageContext.request.contextPath}/PianteServlet" class="action-button add-button"></a>
            </div>

            <div class="admin-menu-item">
                <h3>Gestione Utenti</h3>
                <p>Visualizza e gestisci gli account degli utenti.</p>
                <a href="gestione-utenti.jsp"> Gestione Utenti</a>
                <a href="<%= request.getContextPath() %>/UtenteServlet">Gestione Utenti</a> 
            </div>
            ...
            <div class="admin-menu-item">
                ...
                <a href="<%= request.getContextPath() %>/OrdineServlet">Gestione Ordini</a> 
            </div>
