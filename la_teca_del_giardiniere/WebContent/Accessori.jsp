                        ...
                        <c:forEach var="accessorio" items="${requestScope.listaAccessori}">
                            <div class="product-card">
                                ...
                                <div class="add-to-cart-container">
                                    <a href="${pageContext.request.contextPath}/CarrelloServlet?action=aggiungi&idProdotto=${accessorio.id}&tipo=accessorio" class="add-to-cart-btn" data-product-id="${accessorio.id}">
