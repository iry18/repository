...
<head>
    ...
    <%-- Puoi usare un CSS comune (es. homepage.css) o crearne uno specifico per l'admin --%>
    ...
    <header>
        <nav>
            <ul>
                ...
                <%-- Aggiungi un link per il logout se lo implementerai --%>
                <li><a href="<%= request.getContextPath() %>/LoginServlet?action=logout">LOGOUT</a></li>
                <%-- Potresti aggiungere altri link utili per l'admin, come un link alla pagina profilo admin --%>
            </ul>
        </nav>
    </header>
    ...
    <section class="admin-dashboard">
        ...
        <div class="admin-menu-grid">
            <div class="admin-menu-item">
                ...
                <a href="<%= request.getContextPath() %>/gestione-piante.jsp">Vai alla Gestione Piante</a>
            </div>

            <div class="admin-menu-item">
                <h3>Gestione Accessori</h3>
                <p>Controlla e aggiorna gli accessori disponibili.</p>
                <a href="<%= request.getContextPath() %>/gestione-accessori.jsp">Vai alla Gestione Accessori</a>
            </div>
